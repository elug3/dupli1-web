...
interface LanguageContextValue {
  ...
  /** Locale-aware date + time for an ISO timestamp; "" when unparseable. */
...
const dictionaries: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    "product.home": "Home",
    "product.bags": "Bags",
    "product.inquireStock": "Inquire about stock",
    "product.brand": "Brand",
    ...
    "cart.promo": "Promotional code ({code})",
    ...
    // Refusal reasons from the promotion service, so the shopper is told
    // which rule bit rather than "invalid code" for everything.
    "promo.walletTitle": "Your codes",
    "promo.walletSaves": "Saves {amount} on this bag",
    "promo.walletApplied": "Applied",
    "promo.invalidCode": "We don't recognise that code.",
    "promo.expired": "This code has expired.",
    "promo.alreadyUsed": "You've already used this code.",
    "promo.exhausted": "This promotion has been fully claimed.",
    "promo.loginRequired": "Sign in to use this code.",
    "promo.unavailable": "We couldn't check that code just now. Please try again.",
    "promo.minSpend": "Your bag doesn't reach this code's minimum spend yet.",
    "promo.category": "This code doesn't apply to the items in your bag.",
    "promo.brand": "This code doesn't apply to these brands.",
    "promo.onSale": "This code doesn't apply to items already on sale.",
    "promo.noLineMatch": "Nothing in your bag qualifies for this code.",
    "promo.notEligible": "This code doesn't apply to your bag.",
    ...
    "checkout.invalidPromo": "Invalid promotional code",
    ...
    "orderDetail.metaTitle": "Order Details | Dupli1",
    "orderDetail.metaDescription": "Track and manage one of your Dupli1 orders.",
    "orderDetail.backToOrders": "All orders",
    "orderDetail.heading": "Order",
    "orderDetail.placedOn": "Placed {date}",
    "orderDetail.loadFailed": "Couldn't load this order. Please try again.",
    "orderDetail.notFound": "We couldn't find that order.",
    "orderDetail.progress": "Progress",
    "orderDetail.stepPlaced": "Order placed",
    "orderDetail.stepPaid": "Payment received",
    "orderDetail.stepConfirmed": "Accepted for fulfillment",
    "orderDetail.stepShipped": "Shipped",
    "orderDetail.stepDelivered": "Delivered",
    "orderDetail.stepFulfilled": "Completed",
    "orderDetail.stepDisputed": "Reported as not received",
    "orderDetail.stepCanceled": "Canceled",
    "orderDetail.items": "Items",
    "orderDetail.quantity": "Qty {count}",
    "orderDetail.unitPrice": "{price} each",
    "orderDetail.summary": "Payment summary",
    "orderDetail.payment": "Payment",
    "orderDetail.paymentReference": "Payment reference",
    "orderDetail.delivery": "Delivery",
    "orderDetail.recipient": "Recipient",
    "orderDetail.recipientPhone": "Phone",
    "orderDetail.address": "Address",
    "orderDetail.pccc": "Customs code (PCCC)",
    "orderDetail.noDelivery": "No delivery details were captured for this order.",
    "orderDetail.tracking": "Tracking",
    "orderDetail.carrier": "Carrier",
    "orderDetail.trackingNumber": "Tracking number",
    "orderDetail.confirmReceipt": "Confirm receipt",
    "orderDetail.confirmingReceipt": "Confirming…",
    "orderDetail.confirmReceiptPrompt": "Confirm that this order arrived? This completes the order.",
    "orderDetail.confirmReceiptFailed": "Couldn't confirm receipt. Please try again.",
    "orderDetail.autoCompleteOn": "Completes automatically on {date} if you don't respond.",
    "orderDetail.reportNotReceived": "I didn't receive this",
    "orderDetail.disputeTitle": "Report a missing delivery",
    "orderDetail.disputeBody": "Tell us what happened and our team will look into it.",
    "orderDetail.disputeReasonPlaceholder": "Optional — what happened?",
    "orderDetail.disputeSubmit": "Submit report",
    "orderDetail.disputeSubmitting": "Submitting…",
    "orderDetail.disputeDismiss": "Never mind",
    "orderDetail.disputeFailed": "Couldn't submit that report. Please try again.",
    "orderDetail.disputeOpen": "You reported this order as not received. Our team is reviewing it.",
    "orderDetail.disputeYourNote": "Your note: {reason}",
    "orderDetail.cancelReason": "Your reason: {reason}",
    ...
    "profile.notUsableWithBag": "Not usable with your current bag",
    "profile.walletHint":
      "Codes issued to your account appear here. Apply one in your bag or at checkout.",
    ...
    "profile.statusConfirmed": "Accepted",
    ...
    "profile.viewOrderDetails": "View details",
    "profile.orderItems": "{count} item",
    "profile.orderItemsPlural": "{count} items",
    "profile.orderMoreItems": "+{count} more",
  ...
  ko: {
    ...
    "product.home": "홈",
    "product.bags": "가방",
    "product.inquireStock": "재고 문의하기",
    "product.brand": "브랜드",
    "product.category": "카테고리",
    "product.material": "소재",
    "product.color": "색상",
    "product.dimensions": "사이즈",
    "product.dimension.width": "가로",
    "product.dimension.height": "세로",
    "product.dimension.depth": "폭",
    ...
    "promo.walletTitle": "내 프로모션 코드",
    "promo.walletSaves": "이 장바구니에서 {amount} 할인",
    "promo.walletApplied": "적용됨",
    "promo.invalidCode": "확인할 수 없는 코드입니다.",
    "promo.expired": "만료된 코드입니다.",
    "promo.alreadyUsed": "이미 사용한 코드입니다.",
    "promo.exhausted": "이 프로모션은 모두 소진되었습니다.",
    "promo.loginRequired": "이 코드를 사용하려면 로그인해 주세요.",
    "promo.unavailable": "지금은 코드를 확인할 수 없습니다. 다시 시도해 주세요.",
    "promo.minSpend": "이 코드의 최소 주문 금액에 아직 미치지 못합니다.",
    "promo.category": "장바구니의 상품에는 사용할 수 없는 코드입니다.",
    "promo.brand": "해당 브랜드에는 사용할 수 없는 코드입니다.",
    "promo.onSale": "이미 세일 중인 상품에는 사용할 수 없는 코드입니다.",
    "promo.noLineMatch": "장바구니에 이 코드를 적용할 수 있는 상품이 없습니다.",
    "promo.notEligible": "장바구니에 적용할 수 없는 코드입니다.",
    ...
    "orderDetail.metaTitle": "주문 상세 | Dupli1",
    "orderDetail.metaDescription": "Dupli1 주문을 조회하고 관리하세요.",
    "orderDetail.backToOrders": "주문 목록",
    "orderDetail.heading": "주문",
    "orderDetail.placedOn": "{date} 주문",
    "orderDetail.loadFailed": "주문을 불러올 수 없습니다. 다시 시도해주세요.",
    "orderDetail.notFound": "해당 주문을 찾을 수 없습니다.",
    "orderDetail.progress": "진행 상황",
    "orderDetail.stepPlaced": "주문 접수",
    "orderDetail.stepPaid": "결제 완료",
    "orderDetail.stepConfirmed": "주문 확인",
    "orderDetail.stepShipped": "배송 시작",
    "orderDetail.stepDelivered": "배송 완료",
    "orderDetail.stepFulfilled": "구매 확정",
    "orderDetail.stepDisputed": "미수취 신고",
    "orderDetail.stepCanceled": "주문 취소",
    "orderDetail.items": "주문 상품",
    "orderDetail.quantity": "수량 {count}",
    "orderDetail.unitPrice": "개당 {price}",
    "orderDetail.summary": "결제 정보",
    "orderDetail.payment": "결제",
    "orderDetail.paymentReference": "결제 번호",
    "orderDetail.delivery": "배송 정보",
    "orderDetail.recipient": "수령인",
    "orderDetail.recipientPhone": "연락처",
    "orderDetail.address": "주소",
    "orderDetail.pccc": "개인통관고유부호",
    "orderDetail.noDelivery": "이 주문에는 저장된 배송 정보가 없습니다.",
    "orderDetail.tracking": "배송 조회",
    "orderDetail.carrier": "택배사",
    "orderDetail.trackingNumber": "운송장 번호",
    "orderDetail.confirmReceipt": "구매 확정",
    "orderDetail.confirmingReceipt": "확정 중…",
    "orderDetail.confirmReceiptPrompt": "상품을 받으셨나요? 확정하면 주문이 완료됩니다.",
    "orderDetail.confirmReceiptFailed": "구매 확정에 실패했습니다. 다시 시도해주세요.",
    "orderDetail.autoCompleteOn": "응답이 없으면 {date}에 자동으로 구매 확정됩니다.",
    "orderDetail.reportNotReceived": "상품을 받지 못했어요",
    "orderDetail.disputeTitle": "미수취 신고",
    "orderDetail.disputeBody": "어떤 문제가 있었는지 알려주시면 담당자가 확인합니다.",
    "orderDetail.disputeReasonPlaceholder": "선택 입력 — 어떤 상황인가요?",
    "orderDetail.disputeSubmit": "신고 접수",
    "orderDetail.disputeSubmitting": "접수 중…",
    "orderDetail.disputeDismiss": "취소",
    "orderDetail.disputeFailed": "신고를 접수할 수 없습니다. 다시 시도해주세요.",
    "orderDetail.disputeOpen": "미수취로 신고된 주문입니다. 담당자가 확인 중입니다.",
    "orderDetail.disputeYourNote": "남기신 내용: {reason}",
    "orderDetail.cancelReason": "요청 사유: {reason}",
    ...
    "signup.welcomeDescription":
      "Dupli1 계정이 준비되었습니다. 프로필, 위시리스트, 프로모션 코드, 주문 내역을 관리할 수 있습니다.",
    ...
    "profile.notUsableWithBag": "현재 장바구니에는 사용할 수 없습니다",
    "profile.walletHint":
      "계정에 발급된 코드가 여기에 표시됩니다. 장바구니나 결제 화면에서 적용하세요.",
    "profile.orders": "주문",
    ...
    "profile.faqApplyPromotionCodeAnswer":
      "결제 화면의 프로모션 코드 입력란에 코드를 입력하세요. 주문당 하나의 코드만 적용할 수 있습니다.",
  ...
  zh: {
    ...
    "product.home": "首页",
    "product.bags": "包袋",
    "product.inquireStock": "咨询库存",
    "product.brand": "品牌",
    "product.category": "分类",
    "product.material": "材质",
    "product.color": "颜色",
    "product.dimensions": "尺寸",
    "product.dimension.width": "宽",
    "product.dimension.height": "高",
    "product.dimension.depth": "深",
    ...
    "promo.walletTitle": "我的促销码",
    "promo.walletSaves": "本次可优惠 {amount}",
    "promo.walletApplied": "已应用",
    "promo.invalidCode": "无法识别该代码。",
    "promo.expired": "该代码已过期。",
    "promo.alreadyUsed": "您已使用过该代码。",
    "promo.exhausted": "该活动名额已全部领完。",
    "promo.loginRequired": "请登录后使用该代码。",
    "promo.unavailable": "暂时无法校验该代码，请稍后再试。",
    "promo.minSpend": "购物车金额尚未达到该代码的最低消费。",
    "promo.category": "该代码不适用于购物车中的商品。",
    "promo.brand": "该代码不适用于这些品牌。",
    "promo.onSale": "该代码不适用于已在促销的商品。",
    "promo.noLineMatch": "购物车中没有符合该代码的商品。",
    "promo.notEligible": "该代码不适用于您的购物车。",
    ...
    "orderDetail.metaTitle": "订单详情 | Dupli1",
    "orderDetail.metaDescription": "查询并管理您的 Dupli1 订单。",
    "orderDetail.backToOrders": "全部订单",
    "orderDetail.heading": "订单",
    "orderDetail.placedOn": "下单时间 {date}",
    "orderDetail.loadFailed": "无法加载该订单，请重试。",
    "orderDetail.notFound": "找不到该订单。",
    "orderDetail.progress": "订单进度",
    "orderDetail.stepPlaced": "已下单",
    "orderDetail.stepPaid": "已付款",
    "orderDetail.stepConfirmed": "已确认",
    "orderDetail.stepShipped": "已发货",
    "orderDetail.stepDelivered": "已送达",
    "orderDetail.stepFulfilled": "已完成",
    "orderDetail.stepDisputed": "已申报未收到",
    "orderDetail.stepCanceled": "已取消",
    "orderDetail.items": "商品",
    "orderDetail.quantity": "数量 {count}",
    "orderDetail.unitPrice": "单价 {price}",
    "orderDetail.summary": "付款明细",
    "orderDetail.payment": "付款",
    "orderDetail.paymentReference": "付款编号",
    "orderDetail.delivery": "配送信息",
    "orderDetail.recipient": "收件人",
    "orderDetail.recipientPhone": "联系电话",
    "orderDetail.address": "地址",
    "orderDetail.pccc": "个人通关号 (PCCC)",
    "orderDetail.noDelivery": "该订单没有保存配送信息。",
    "orderDetail.tracking": "物流查询",
    "orderDetail.carrier": "承运商",
    "orderDetail.trackingNumber": "运单号",
    "orderDetail.confirmReceipt": "确认收货",
    "orderDetail.confirmingReceipt": "确认中…",
    "orderDetail.confirmReceiptPrompt": "确认已收到该订单？确认后订单即完成。",
    "orderDetail.confirmReceiptFailed": "确认收货失败，请重试。",
    "orderDetail.autoCompleteOn": "若未回应，将于 {date} 自动完成。",
    "orderDetail.reportNotReceived": "我没有收到商品",
    "orderDetail.disputeTitle": "申报未收到商品",
    "orderDetail.disputeBody": "请告知具体情况，我们会尽快核查。",
    "orderDetail.disputeReasonPlaceholder": "选填 — 发生了什么？",
    "orderDetail.disputeSubmit": "提交申报",
    "orderDetail.disputeSubmitting": "提交中…",
    "orderDetail.disputeDismiss": "暂不提交",
    "orderDetail.disputeFailed": "无法提交申报，请重试。",
    "orderDetail.disputeOpen": "该订单已申报未收到，我们正在核查。",
    "orderDetail.disputeYourNote": "您的说明：{reason}",
    "orderDetail.cancelReason": "申请理由：{reason}",
    ...
    "signup.welcomeDescription":
      "您的 Dupli1 账户已准备就绪。现在可以管理个人资料、愿望清单、促销码和订单。",
    ...
    "profile.notUsableWithBag": "当前购物车无法使用",
    "profile.walletHint": "发放到您账户的代码会显示在这里，可在购物车或结账时使用。",
    "profile.orders": "订单",
    ...
    "profile.faqApplyPromotionCodeAnswer":
      "在结账时的促销码输入框中输入您的促销码。每个订单只能使用一个代码。",
...
/**
 * Order timestamps arrive as UTC ISO strings and render in the viewer's own
 * time zone — only ever from client-side data, so there is no SSR/hydration
 * mismatch to guard against.
 */
function formatDateTimeIn(locale: string, iso: string | undefined | null): string {
  if (!iso) return "";
...
const fallbackLanguageContext: LanguageContextValue = {
  ...
  formatDateTime: (iso) => formatDateTimeIn("ko-KR", iso),
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo<LanguageContextValue>(() => {
    ...
    function formatDateTime(iso: string | undefined | null): string {
      return formatDateTimeIn(languageOption.locale, iso);
    }
