...
const dictionaries: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    "checkout.methodCreditCardHint": "Pay securely via Stripe Checkout",
    "checkout.methodSecureRedirect": "Secure redirect",
    "checkout.methodBypass": "Mark as paid (bypass)",
    "checkout.methodBypassHint": "Record cash or offline payment without Stripe",
    ...
    "checkout.paymentNote":
      "You'll be redirected to complete payment securely — Dupli1 never sees or stores your card details.",
  ...
  ko: {
    ...
    "checkout.methodCreditCardHint": "Stripe Checkout으로 안전하게 결제",
    "checkout.methodSecureRedirect": "보안 이동",
    "checkout.methodBypass": "결제 완료 처리 (우회)",
    "checkout.methodBypassHint": "Stripe 없이 현금·오프라인 결제를 기록합니다",
    ...
    "checkout.cvc": "CVC",
    "checkout.paymentNote":
      "안전한 결제 페이지로 이동합니다 — Dupli1은 카드 정보를 저장하거나 확인하지 않습니다.",
  ...
  zh: {
    ...
    "checkout.methodCreditCardHint": "通过 Stripe Checkout 安全付款",
    "checkout.methodSecureRedirect": "安全跳转",
    "checkout.methodBypass": "标记已付（绕过）",
    "checkout.methodBypassHint": "记录现金或线下付款，无需 Stripe",
    ...
    "checkout.cvc": "CVC",
    "checkout.paymentNote":
      "您将被重定向至安全支付页面 — Dupli1 不会查看或存储您的卡片信息。",
