...
const dictionaries: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    "profile.ordersHint": "View your order history and shipping status.",
    "profile.viewOrders": "View orders",
    "orders.eyebrow": "Account",
    "orders.title": "Orders",
    "orders.subtitle": "Track payment and shipping status for every order.",
    ...
    "orders.carrierCj": "CJ Logistics",
    "orders.carrierHanjin": "Hanjin",
    "orders.carrierLotte": "Lotte",
    "orders.carrierLogen": "Logen",
    "orders.carrierEpost": "Korea Post",
    "orders.carrierOther": "Other",
    "orders.statusPending": "Pending payment",
    "orders.statusPaid": "Paid",
    "orders.statusInTransit": "In transit",
    "orders.statusFulfilled": "Delivered",
    ...
    "profile.faqTrackOrderAnswer":
      "Open Orders from your account to see payment and shipping status. After we ship, the carrier and tracking number appear there with a link to the courier when available.",
  ...
  ko: {
    ...
    "profile.ordersHint": "주문 내역과 배송 상태를 확인하세요.",
    "profile.viewOrders": "주문 보기",
    "orders.eyebrow": "계정",
    "orders.title": "주문",
    "orders.subtitle": "결제와 배송 상태를 확인하세요.",
    "orders.loading": "주문을 불러오는 중…",
    "orders.loadFailed": "주문을 불러오지 못했습니다.",
    "orders.tracking": "배송 추적",
    "orders.trackShipment": "택배 조회",
    "orders.carrier": "택배사",
    "orders.carrierCj": "CJ대한통운",
    "orders.carrierHanjin": "한진택배",
    "orders.carrierLotte": "롯데택배",
    "orders.carrierLogen": "로젠택배",
    "orders.carrierEpost": "우체국택배",
    "orders.carrierOther": "기타",
    "orders.statusPending": "결제 대기",
    "orders.statusPaid": "결제 완료",
    "orders.statusInTransit": "배송 중",
    "orders.statusFulfilled": "배송 완료",
    "orders.statusCanceled": "취소됨",
    ...
    "profile.faqTrackOrderAnswer":
      "계정에서 주문을 열면 결제·배송 상태를 확인할 수 있습니다. 출고 후 택배사와 운송장 번호가 표시되며, 가능한 경우 택배사 조회 링크로 연결됩니다.",
  ...
  zh: {
    ...
    "profile.ordersHint": "查看订单历史与物流状态。",
    "profile.viewOrders": "查看订单",
    "orders.eyebrow": "账户",
    "orders.title": "订单",
    "orders.subtitle": "查看每笔订单的付款与物流状态。",
    "orders.loading": "正在加载订单…",
    "orders.loadFailed": "无法加载订单。",
    "orders.tracking": "物流追踪",
    "orders.trackShipment": "查询物流",
    "orders.carrier": "承运商",
    "orders.carrierCj": "CJ物流",
    "orders.carrierHanjin": "韩进",
    "orders.carrierLotte": "乐天",
    "orders.carrierLogen": "Logen",
    "orders.carrierEpost": "韩国邮政",
    "orders.carrierOther": "其他",
    "orders.statusPending": "待付款",
    "orders.statusPaid": "已付款",
    "orders.statusInTransit": "运输中",
    "orders.statusFulfilled": "已送达",
    "orders.statusCanceled": "已取消",
    ...
    "profile.faqTrackOrderAnswer":
      "在账户中打开订单即可查看付款与物流状态。发货后会显示承运商和运单号，并在可用时提供快递查询链接。",
