...
const dictionaries: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    "cart.promoExpired": "This promotional code has expired.",
    "cart.promoAlreadyUsed": "You have already used this promotional code.",
    "cart.promoExhausted": "This promotion has ended.",
    "cart.promoLoginRequired": "Sign in to use this promotional code.",
    "cart.promoNotEligible": "This promotional code does not apply to your cart.",
    "cart.promoMinSpend": "Your order does not meet this code's minimum spend.",
    "cart.promoRemove": "Remove",
    "profile.promotionNotAvailable": "Not available right now.",
    "cart.yourPromoCodes": "Your promotional codes",
    "cart.promoAppliedLabel": "Applied",
    "profile.promotionExpiresOn": "Valid until {date}",
    "profile.loading": "Loading…",
    "cart.discountAppliedWon": "{amount} off applied",
    ...
    "profile.statusFulfilled": "Delivered",
  ...
  ko: {
    ...
    "cart.promoExpired": "만료된 프로모션 코드입니다.",
    "cart.promoAlreadyUsed": "이미 사용한 프로모션 코드입니다.",
    "cart.promoExhausted": "종료된 프로모션입니다.",
    "cart.promoLoginRequired": "로그인 후 사용할 수 있는 프로모션 코드입니다.",
    "cart.promoNotEligible": "장바구니에 적용할 수 없는 프로모션 코드입니다.",
    "cart.promoMinSpend": "최소 주문 금액을 충족하지 않습니다.",
    "cart.promoRemove": "삭제",
    "profile.promotionNotAvailable": "현재 사용할 수 없습니다.",
    "cart.yourPromoCodes": "보유 프로모션 코드",
    "cart.promoAppliedLabel": "적용됨",
    "profile.promotionExpiresOn": "{date}까지 사용 가능",
    "profile.loading": "불러오는 중…",
    "cart.discountAppliedWon": "{amount} 할인이 적용되었습니다",
  ...
  zh: {
    ...
    "cart.promoExpired": "该促销码已过期。",
    "cart.promoAlreadyUsed": "您已使用过该促销码。",
    "cart.promoExhausted": "该促销活动已结束。",
    "cart.promoLoginRequired": "请登录后使用该促销码。",
    "cart.promoNotEligible": "该促销码不适用于您的购物车。",
    "cart.promoMinSpend": "订单未达到该促销码的最低消费。",
    "cart.promoRemove": "移除",
    "profile.promotionNotAvailable": "当前不可用。",
    "cart.yourPromoCodes": "我的促销码",
    "cart.promoAppliedLabel": "已应用",
    "profile.promotionExpiresOn": "有效期至 {date}",
    "profile.loading": "加载中…",
    "cart.discountAppliedWon": "已优惠 {amount}",
